...
- [x] 현재 Cafe24 sitemap 119개 URL을 `LEGACY_SHOP_URL_INVENTORY.csv`로 수집하고 path-preserving shop 이동 규칙 초안 작성
...
- 현재 Cafe24 sitemap 및 샘플 상품 canonical이 `adeliedraw.cafe24.com`을 가리키고 있음을 확인. Shop 대표 도메인 전환 시 SEO 메타 검증 항목으로 추가함.
